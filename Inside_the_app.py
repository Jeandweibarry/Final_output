...
class GUI:
    def Transfer_data(self):
        ...
        # INSERT
        query1 = """INSERT INTO basic_info (first_name, middle_name, last_name, suffix, date_of_birth, gender, nationality, civil_status, department, designation, qualified_department, employee_status, paydate, employee_number) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)"""
    ...
    def create_content(self):
        ...
        self.other_social_mediatxt = gui_design2.create_combobox(self.frame3, 40, 110,
        ...
        self.choosebutton = gui_design2.create_button(self.frame1, lambda: self.Transfer_data(), 20, 100, 'Choose File', '#AB9C9C', 10, 1, 7)
        ...
        return self.firstnametxt, self.middle_nametxt, self.lastnametxt, self.suffixttxt, self.datebirthtxt, self.gendercombobox, self.nationalitytxt, self.civilstatuscombobox,\
        self.departmenttxt, self.designationtxt, self.qualified_deptxt, self.employee_statustxt, self.paydatetxt, self.employee_numbertxt, self.contact_numbertxt, self.emailtxt,\
        self.other_social_mediatxt, self.social_media_accounttxt, self.addressheading, self.add_line1txt, self.add_line2txt, self.citytxt, self.state_provincetxt, self.countrytxt,\
        self.zipcodetxt, self.picture_pathtxt